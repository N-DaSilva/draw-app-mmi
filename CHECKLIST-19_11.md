...
- [x] Je peux dessiner une ligne continue avec la souris onMouseDown -> onMouseMove -> onMouseUp
- [ ] Le canvas est net sur Retina (DPR correctement géré)
- [x] Les listeners mouse sont bien nettoyés  (removeEventListener dans le onMouseUp)
